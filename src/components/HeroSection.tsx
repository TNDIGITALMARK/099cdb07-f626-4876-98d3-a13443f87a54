...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className={`relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden ${className}`}>
      {/* Background Image */}
      <div 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center lg:text-left">
        <div className="lg:max-w-2xl">
          ...
          <div className="space-y-2 mb-6">
            ...
            <h2 className="heading-display text-white drop-shadow-lg">
              {subtitle}
            </h2>
          </div>

          {/* Description */}
          <p className="text-lg md:text-xl text-white/90 mb-8 leading-relaxed drop-shadow-sm max-w-lg lg:max-w-none">
            {description}
          </p>
